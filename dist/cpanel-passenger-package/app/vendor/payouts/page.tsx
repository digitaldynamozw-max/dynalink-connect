        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div className="bg-white rounded-lg shadow p-6">
              ...
              <p className="text-sm text-gray-600 mt-1">Submitted to admin for approval</p>
            </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-blue-800">
                    You have ${formatCurrency(stats.pendingPayout)} available. Minimum withdrawal is $100.
                  </p>
                </div>
                <button
          ...
          {stats.pendingPayout < 100 && stats.pendingPayout > 0 && (
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6 mb-8">
              ...
              <p className="text-sm text-yellow-800">
                You need at least $100 to request a payout. Current: ${formatCurrency(stats.pendingPayout)}
                (${formatCurrency(100 - stats.pendingPayout)} more needed)
              </p>
            </div>
          )}

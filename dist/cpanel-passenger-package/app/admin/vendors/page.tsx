...
import { AdminInsightCard, AdminPageHeader, AdminStatCard, AdminTableWrap } from '@/components/admin-ui'
...
type VendorTopTab = 'vendors' | 'balances' | 'statistics' | 'settings'
...
export default function AdminVendorsPage() {
  ...
  const [activeSection, setActiveSection] = useState<VendorSection>('active')
  const [activeTopTab, setActiveTopTab] = useState<VendorTopTab>('vendors')
  const [sortBy, setSortBy] = useState<VendorSort>('priority')
                            ...
                            <tr key={vendor.id} className="border-t border-slate-100">
                              ...
                              <td className="px-3 py-2">
                                <div className="flex flex-wrap items-center justify-end gap-2">
                                  ...
                                  <span className="rounded-lg border border-slate-200 px-2.5 py-1.5 text-[11px] font-semibold text-slate-500">
                                    Edit from settings
                                  </span>
                                </div>
                              </td>
                          ...
                          <tr key={vendor.id} className="border-t border-slate-100">
                            ...
                            <td className="px-3 py-2">
                              <div className="flex justify-end gap-2">
                                ...
                                <span className="rounded-lg bg-slate-200 px-2.5 py-1.5 text-[11px] font-semibold text-slate-700">
                                  Details listed
                                </span>
                              </div>
                            </td>
...
function isVendorTopTab(value: string): value is VendorTopTab {
  return ['vendors', 'balances', 'statistics', 'settings'].includes(value)
}

...
export default function VendorRegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : 'Failed to register as vendor')
    } finally {
      setLoading(false)
    }
  }
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <p className="text-center text-sm text-gray-600">
              Already a vendor? <Link href="/vendor/dashboard" className="text-blue-600 hover:text-blue-700 font-semibold">Go to Dashboard</Link>
            </p>
          </form>
        </div>
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600 text-sm">Store location used by the admin delivery team</p>
          </div>
          <div className="text-center">

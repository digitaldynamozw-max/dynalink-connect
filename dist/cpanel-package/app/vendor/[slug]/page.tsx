...
import { matchesVendorSlug, toVendorSlug } from '@/lib/vendor-slug'
          ...
          <div className="relative flex flex-col items-start space-y-6 md:flex-row md:items-center md:space-x-8 md:space-y-0">
            ...
            <div className="flex-1">
              ...
              <div className="flex flex-wrap items-center gap-6">
                ...
                >
                  {availability.isOpenNow ? 'Open now' : 'Currently closed'}
                </div>
            ...
            <div className="flex min-w-0 flex-1 items-center gap-4">
              ...
              <div className="min-w-0">
                ...
                <p className="truncate text-lg font-bold text-slate-900">
                  {vendor.vendorPhoneNumber || 'Not listed'}
                </p>
                <p className="text-sm text-slate-500">
                  Store details stay private until order fulfillment.
                </p>
              </div>
            </div>
...
export async function generateStaticParams() {
  try {
    ...
    return vendors
      .filter((vendor) => Boolean(vendor.vendorName))
      .map((vendor) => ({
        slug: toVendorSlug(vendor.vendorName as string),
      }))
  } catch (error) {
    console.warn('Skipping vendor static params generation during build:', error)
    return []
  }
}
